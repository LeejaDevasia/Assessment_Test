...
await cartItems
  .nth(i)
  .locator(cartLocators.removeButton)
  .click();
...
await expect(
page.locator(cartLocators.cartItems)
).toHaveCount(0);
}
...
const product = page
.locator(cartLocators.cartItems)
.filter({
hasText: productName
});
...
await page.locator(cartLocators.continueShopping)
.click();
}

async function checkout(page) {

await page.locator(cartLocators.checkout)
.click();
}
